...
pub trait Object3D {
    ...
    fn render(&self, _display: &glium::Display<WindowSurface>, _frame: &mut glium::Frame, screen: [[f32; 4]; 4], camera_view: [[f32; 4]; 4], perspective: [[f32; 4]; 4], global_light: [f32; 3], params: &glium::DrawParameters);
}
...
impl Object3D for Cube {
    ...
    // Отрисовка куба
    fn render(&self, _display: &glium::Display<WindowSurface>, _frame: &mut glium::Frame, screen: [[f32; 4]; 4], camera_view: [[f32; 4]; 4], perspective: [[f32; 4]; 4], global_light: [f32; 3], params: &DrawParameters)  {
...
impl Object3D for Teapod {
    ...
    fn render(&self, _display: &glium::Display<WindowSurface>, _frame: &mut glium::Frame, screen: [[f32; 4]; 4], camera_view: [[f32; 4]; 4], perspective: [[f32; 4]; 4], global_light: [f32; 3], params: &glium::DrawParameters) {
        ...
        &uniform! { matrix: screen, perspective: perspective, u_light: global_light },
        &params).unwrap();
    }
}